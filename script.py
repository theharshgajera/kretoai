ffrom flask import Flask, render_template, request, jsonify, session
...
for Target == 30 seconds video scirpt don't follow structural timing or format rules. you just need to generate 3-4 sentence so there will be no rule just make sure to have heading and \n\n sentences. (make sure to use \n\n to maintain line break between heading and sentences.)
